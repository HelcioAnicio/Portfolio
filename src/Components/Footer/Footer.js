            ...
            <div className="DivForm">
                ...
                <form onSubmit={cadastrarUsuario}>
                    <fieldset>
                        ...
                        />
                        {!name && formSubmitted && <div className='Error'><p>Please fill in the first name correctly</p></div>}
                        ...
                        />
                        {formSubmitted && telephone === '' && <div className="Error"><p>Please fill in the telephone correctly.</p></div>}
