...
export const CardImage = () => {
  return (
    <Card className="flex h-full w-full flex-col items-center justify-center border border-white bg-transparent py-0 shadow-none sm:justify-evenly sm:gap-16 sm:px-0 lg:flex-row lg:justify-between">
      <CardHeader>
